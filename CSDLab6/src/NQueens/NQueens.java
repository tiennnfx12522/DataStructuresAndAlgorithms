...
public class NQueens {
    ...
    List<List<Integer>> nQueen(int n) {
    ...
    void solveNQUtil(List<List<Integer>> result, int n, int row, List<Integer> comb){
        if (row == n) {
            // if row equals to n it means we have successfully placed all n queens.
